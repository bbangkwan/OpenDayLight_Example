...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "example-impl";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:example:impl";
    private final String revision = "2014-12-10";
    private final String resourcePath = "/META-INF/yang/example-impl.yang";
